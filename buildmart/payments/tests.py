...
class PaymentTestCase(TestCase):
    def setUp(self):
        self.user = User.objects.create_user(
            username='testuser',
            password='password',
            email='testuser@example.com'  # Add an email argument
    )
    def test_create_payment(self):
        # Create a Payment instance with all required fields
    ...
    def test_payment_without_user(self):
        """Test creating a payment without a user raises an error."""
    ...
    def test_str_method(self):
        ...
        expected_str = f"Payment unique_request_id - Pending by {self.user.username}"
